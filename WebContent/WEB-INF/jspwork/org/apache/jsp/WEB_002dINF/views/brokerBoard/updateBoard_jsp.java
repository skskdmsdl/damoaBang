 ...
 * Generated at: 2020-08-16 03:16:29 UTC
...
public final class updateBoard_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(brokerLoggedIn == null) { 
	...
	List<RoomImage> imgList = (List<RoomImage>)request.getAttribute("imgList");
      ...
      out.write("        <form action=\"");
      out.print( request.getContextPath() );
      out.write("/brokerBoard/boardUpdate\" method=\"post\" enctype=\"multipart/form-data\">\r\n");
      out.write("\t\t\t<input type=\"hidden\" name=\"board_num\" value=\"");
      out.print(r.getBoard_num() );
      out.write("\" />\r\n");
      out.write("\t\t    <section>\r\n");
      out.write("\t\t        <input type=\"text\" name=\"board_title\" id=\"boardTitle\" placeholder=\"제목을 적어주세요\" value=\"");
      out.print( rb.getBoard_title()  );
      out.write("\" >\r\n");
      out.write("\t\t\t</section>\r\n");
      out.write("\t\t\t<section id=\"roomUpSection\">\r\n");
      out.write("\t            <select name=\"room_val\" class=\"selectOption\"  >\r\n");
      out.write("\t                <option value=\"OO\" ");
      out.print( r.getRoom_val().equals("OO") ? "selected" : "" );
      out.write(" >오픈형 원룸</option> \r\n");
      out.write("\t                <option value=\"SO\" ");
      out.print( r.getRoom_val().equals("SO") ? "selected" : "" );
      out.write(">분리형 원룸</option>\r\n");
      out.write("\t                <option value=\"OT\" ");
      out.print( r.getRoom_val().equals("OT") ? "selected" : "" );
      out.write(">오픈형 투룸</option>\r\n");
      out.write("\t                <option value=\"ST\" ");
      out.print( r.getRoom_val().equals("ST") ? "selected" : "" );
      out.write(">분리형 투룸</option>\r\n");
      out.write("\t            </select>\r\n");
      out.write("\t\r\n");
      out.write("\t            <select name=\"tax_val\" class=\"selectOption\" >\r\n");
      out.write("\t                <option value=\"M\" ");
      out.print( r.getTax_val().equals("M") ? "selected" : "" );
      out.write(" >월세</option>\r\n");
      out.write("\t                <option value=\"Y\" ");
      out.print( r.getTax_val().equals("Y") ? "selected" : "" );
      out.write(">전세</option>\r\n");
      out.write("\t            </select>\r\n");
      out.write("\t\r\n");
      out.write("\t            <select name=\"price\" class=\"selectOption\" >\r\n");
      out.write("\t                <option value=45 ");
      out.print(  r.getPrice()==45? "selected" : "" );
      out.write(">월 ~ 45</option>\r\n");
      out.write("\t                <option value=100 ");
      out.print(  r.getPrice()==100? "selected" : "" );
      out.write(">45 ~ 100</option>\r\n");
      out.write("\t            </select>\r\n");
      out.write("\t\r\n");
      out.write("\t            <select name=\"fee\" class=\"selectOption\" >\r\n");
      out.write("\t                <option value=5 ");
      out.print(  r.getFee()==5? "selected" : "" );
      out.write(">관리비 ~5만</option>\r\n");
      out.write("\t                <option value=10 ");
      out.print(  r.getFee()==10? "selected" : "" );
      out.write(">5~10만 </option>\r\n");
      out.write("\t                <option value=20 ");
      out.print(  r.getFee()==20? "selected" : "" );
      out.write(">10~20만</option>\r\n");
      out.write("\t            </select>\r\n");
      out.write("\t            <select name=\"size\" class=\"selectOption\" >\r\n");
      out.write("\t                <option value=14 ");
      out.print(  r.getSize()==14? "selected" : "" );
      out.write(">14평</option>\r\n");
      out.write("\t                <option value=24 ");
      out.print(  r.getSize()==24? "selected" : "" );
      out.write(">24평</option>\r\n");
      out.write("\t                <option value=34 ");
      out.print(  r.getSize()==34? "selected" : "" );
      out.write(">34평</option>\r\n");
      out.write("\t            </select>\r\n");
      out.write("\t            <span>\r\n");
      out.write("\t            \t입주가능일 : <input type=\"date\" name=\"movedate\" id=\"movedate\" value=\"");
      out.print( r.getMovedate() );
      out.write("\">\r\n");
      out.write("\t            </span>\r\n");
      out.write("\t            <span>\r\n");
      out.write("\t            \t층 : <input type=\"text\" name=\"floor\" id=\"floor\" value=\"");
      out.print( r.getFloor() );
      out.write("\">\r\n");
      out.write("\t            </span>\r\n");
      out.write("\t\t\t</section>\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t\t            <textarea rows=\"5\" cols=\"40\" name=\"boardContent\" id=\"roomUpdateTxt\"  >");
      out.print( rb.getContent() );
      out.write("</textarea>\r\n");
      ...
      out.write("\t\t\t\t            <input type=\"text\" name=\"location\" id=\"localSearch\" placeholder=\"방 위치를 입력해주세요\" value=\"");
      out.print( r.getLocation() );
      out.write("\" required>\r\n");
      ...
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t            </div>\r\n");
      out.write("\t\t\t\t\t<div  id=\"roomUpFile\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t    </section>\r\n");
      ...
      out.write("}\r\n");
      out.write("//지도 위치 잡아주기\r\n");
      out.write("$(document).ready(function(){\r\n");
      out.write("\t$(\".room-searchBtn\").trigger(\"click\");\r\n");
      out.write("})\r\n");
      out.write("\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
