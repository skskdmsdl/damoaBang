 ...
 * Generated at: 2020-08-16 03:15:05 UTC
...
if (memberLoggedIn.getMemberRole().equals("U")) {
      ...
      out.write("    $(\"table *\").removeAttr(\"style\");\r\n");
      out.write("}\r\n");
      out.write("$(document).ready(function(){\r\n");
      out.write("    $(\"tbody tr\").not(\".br_enrollInput\").mouseenter(function(){\r\n");
      out.write("        clear();\r\n");
      out.write("        $(this).css(\"background\", \"#ff934c9e\");\r\n");
      out.write("\r\n");
      out.write("    });\r\n");
      out.write("});\r\n");
      out.write("let tdArray = \"\";\r\n");
      out.write("$(document).ready(function(){\r\n");
      out.write("    $(\"tbody tr\").not(\".br_enrollInput\").click(function(){\r\n");
      out.write("        clear();\r\n");
      out.write("        $(this).css(\"background\", \"#ff934c9e\");\r\n");
      out.write("\r\n");
      out.write("        let tr = $(this); \r\n");
      out.write("        let td = tr.children();\r\n");
      out.write("       \r\n");
      out.write("        tdArray = new Array(); // 배열에 값 담기\r\n");
      out.write("        td.each(function(i){\r\n");
      out.write("            tdArray.push(td.eq(i).text());\r\n");
      out.write("        });\r\n");
      out.write("        \r\n");
      out.write("        //alert(tdArray[0]);\r\n");
      out.write("        setTimeout(deleteMember, 300);\r\n");
      out.write("    });\r\n");
      out.write("}); \r\n");
      out.write("function deleteMember(){\r\n");
      out.write("\tif(!confirm(\"이 회원을 블랙리스트로 이동\")) return;\r\n");
      out.write("\t\r\n");
      out.write("\t$.ajax({\r\n");
      out.write("\t\turl: \"");
      out.print( request.getContextPath() );
      ...
      out.write("\t\t\t</form>\t\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div id=\"search-memberEnoll\">\r\n");
      out.write("\t\t\t<form name=\"adminBrokerEnrollFrm\" action=\"");
      out.print( request.getContextPath() );
      out.write("/admin/brokerEnroll\" method=\"post\">\r\n");
      out.write("\t\t    \t\r\n");
      out.write("\t\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t<tr class=\"br_enrollInput\">\r\n");
      out.write("\t\t\t<th>\r\n");
      out.write("\t\t\t\t<input type=\"text\" class=\"input-field2\"  name=\"br_cp_id\" id=\"br_cp_id\" placeholder=\"번호입력\" required>\r\n");
      out.write("\t\t\t</th>\r\n");
      out.write("\t\t\t<td>\t\r\n");
      ...
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t\t<td>\t\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"insurance\" id=\"insurance\" placeholder=\"T or F\" ><br />\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t\t<th></th>\r\n");
      out.write("\t\t\t<th></th>\r\n");
      out.write("\t\t\t<th></th>\r\n");
      ...
      out.write("\t\t</tbody>\r\n");
      out.write("\t</table>\r\n");
      out.write("\t<input class=\"sumitBtn\" type=\"submit\" value=\"회원등록\" >\r\n");
      out.write("\t\t    </form>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t\r\n");
