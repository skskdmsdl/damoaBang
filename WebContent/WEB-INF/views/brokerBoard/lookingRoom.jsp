...
$(document).ready(function(){
	...
	<div class="nav-bar">
		<a href="<%=request.getContextPath()%>/board/lookingRoom" class="RoomSearch-nav">매물 검색</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	</div>
	
		<div class="lookinRoomView">
		     	<section id="option-tab" style="display: inline;">
		     	<form action="<%= request.getContextPath() %>/brokerBoard/searchRoom" style="display: inline">
		     		...
		     		<form id="map-searchFrm" action="<%= request.getContextPath() %>/brokerBoard/searchLocationRoom" onsubmit="return searchPlaces();">
	 ...
	 if(list == null || list.isEmpty()){ %>           
		...
		<div>
            <a href="<%= request.getContextPath() %>/brokerBoard/boardView?board_num=<%= b.getBoard_num() %>&br=<%= b.getBr_cp_id() %>" >
                <% if(b.getOk().equals("T")){ %>
                	<img src="<%=request.getContextPath()%>/upload/board/<%=b.getRenameName() %>" onerror="this.src='<%= request.getContextPath() %>/images/roomImg01.jpg'">
            	<% } else{ %>
                	<img src="<%=request.getContextPath()%>/upload/board/<%=b.getRenameName() %>" onerror="this.src='<%= request.getContextPath() %>/images/roomImg01.jpg'" style="filter: brightness(50%);">
            	<% } %> 
            </a>
            <br>
