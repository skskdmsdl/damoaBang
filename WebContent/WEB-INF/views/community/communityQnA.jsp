				...
				<div class="col-4 col-6-medium col-12-small">
					...
					<div class="questions-filter__content container">
						...
						<div class="questions-filter__actions">
							<a class="set-reply btn btn-normal btn-sm" href="<%=request.getContextPath() %>/community/communityQnAzero"> 답변을 기다리는 질문</a> <a class="questions-filter__actions__new-question btn btn-priority btn-sm" href="<%=request.getContextPath()%>/community/communityQuestion">질문하기</a>
						</div>
					</div>
				</div>
...
<!-- 								<img src="https://image.ohou.se/image/central_crop/bucketplace-v2-development/uploads-cards-snapshots-1548687459_vMyG4GyO.jpeg/320/320"> -->
								<img src="<%=request.getContextPath()%>/upload/community/<%=cb.getRenamename() %>" onerror="this.src='<%= request.getContextPath() %>/images/roomImg01.jpg'">
<%-- 								<img src="<%=request.getContextPath()%>/upload/community/<%=comboard.getRenamename() %>" onerror="this.src='https://image.ohou.se/image/central_crop/bucketplace-v2-development/uploads-cards-snapshots-1548687459_vMyG4GyO.jpeg/320/320"> --%>
							</div>
						</div>
